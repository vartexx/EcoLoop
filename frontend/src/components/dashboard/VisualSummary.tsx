    ...
    <div className="space-y-6">
        ...
        <div className="glass rounded-3xl p-6 border border-white/20 relative overflow-hidden shadow-xl flex flex-col justify-between">
          <div className="flex justify-between items-start">
            <div>
              ...
              <div className="text-3xl font-extrabold text-foreground mt-1 flex items-baseline">
        ...
        <div className="glass rounded-3xl p-6 border border-white/20 relative overflow-hidden shadow-xl flex flex-col justify-between">
          <div className="flex justify-between items-start">
            <div>
              ...
              <div className="text-3xl font-extrabold text-primary mt-1 flex items-baseline">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="glass rounded-3xl p-6 border border-white/20 shadow-xl flex flex-col justify-between min-h-[360px]">
          <div>
            <h2 className="text-md font-bold text-foreground">Carbon Footprint Breakdown</h2>
        ...
        <div className="glass rounded-3xl p-6 border border-white/20 shadow-xl flex flex-col justify-between min-h-[360px]">
          <div>
            <h2 className="text-md font-bold text-foreground">Comparison Benchmark</h2>
