...
export default function AICoach({ inputs }: AICoachProps) {
  ...
  useEffect(() => {
    ...
    const welcomeText = `Hello! I am your AI Sustainability Coach. 🌲 
  ...
  return (
    <div className="glass rounded-3xl p-6 border border-white/20 shadow-xl flex flex-col h-[520px]">
      ...
      <div className="flex items-center space-x-2 border-b border-border/50 pb-3">
        ...
        <div>
          <h3 className="text-sm font-bold text-foreground">AI Sustainability Coach</h3>
      ...
      <div className="flex items-center space-x-1.5 overflow-x-auto pb-2 pt-1 border-t border-border/30">
        {[
          ...
          <button
            ...
            className="flex-shrink-0 px-3 py-1.5 text-[10px] font-semibold rounded-full border border-border bg-muted/65 hover:bg-accent/40 text-foreground transition"
          >
            {chip.label}
          </button>
        ))}
      ...
      >
        ...
        <button
          ...
          className="p-2.5 rounded-xl bg-primary text-primary-foreground shadow-lg hover:shadow-primary/20 hover:scale-105 disabled:opacity-40 disabled:scale-100 disabled:shadow-none transition flex items-center justify-center"
