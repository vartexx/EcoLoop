  ...
  return (
    <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
      ...
      <div className="lg:col-span-2 glass rounded-3xl p-6 border border-white/20 shadow-xl space-y-4">
        <div>
          <h3 className="text-lg font-bold text-foreground">Daily Habit Tracker</h3>
              ...
              >
                <div className="flex justify-between items-start space-x-2">
                  <div className="space-y-1">
                    ...
                    <h4 className="text-xs font-bold text-foreground line-clamp-1">{habit.title}</h4>
                  </div>
              ...
              >
                ...
                <div className="flex-1 space-y-0.5">
                  <div className="flex items-baseline justify-between">
                    <h4 className={`text-xs font-bold ${isUnlocked ? 'text-foreground' : 'text-muted-foreground'}`}>
                      {badge.title}
                    </h4>
                    {!isUnlocked && (
